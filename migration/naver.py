...
class Naver(Provider):
    ...
    def parsing_element(self, artifacts, board_type):
        ...
        for id_tag in tqdm(artifact_list):
            ...
            if not r_artifact.content:
                log_msg = 'BLANK_XML__Repo: {0}, Id: {1}, Type: {2}'.format(self._repo_name, artifact_id, board_type)
        ...
        if not board_type is 'download':
            ...
            if attachments:
                ...
                for item in attachments:
                    ...
                    body_uploaded_link = 'https://github.com/{0}/{1}/wiki/attachFile/{2}/{3}/{4}'.format(
                        self._gh._username,
                        self._gh._repo_name,
                        id_,
                        body_file_id,
